    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnOperacao.setOnClickListener(
                v -> {
                    ...
                    //TODO lembrar de implementar validação dos números das contas e do valor da
                    // operação, antes de efetuar a operação de transferência. O método abaixo
                    // está sendo chamado, mas precisa ser implementado para funcionar.

                    if (numOrigem.length() == 0 || numDestino.length() == 0 || valOperacao.length() == 0) {
                    ...
                    } else if (numDestino.length() == 0 || Double.valueOf(numDestino) <= 0) {
                            Toast.makeText(this, "Digite o número da conta positivo e com pelo menos 1 digito", Toast.LENGTH_SHORT).show();
                     } else {
